      ...
      <v-container fluid class="pa-3">
          <v-row class="h-100vh d-flex justify-center align-center">
              <v-col cols="12" lg="4" xl="3" class="d-flex align-center">
                  <v-card rounded="md" elevation="10" class="px-sm-1 px-0 withbg mx-auto mt-4" max-width="500">
                      <v-card-item class="pa-sm-6">
                          ...
                          <v-row class="d-flex mb-3">
                            ...
                            <v-col cols="12">
                                <v-label class="font-weight-bold mb-1">CPF</v-label>
                                <v-text-field variant="outlined" hide-details color="primary"></v-text-field>
                            </v-col>
                            <v-col cols="12">
